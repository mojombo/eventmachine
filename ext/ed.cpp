...
void EventableDescriptor::SetProxiedFrom(EventableDescriptor *from, unsigned long bufsize)
{
	ProxiedFrom = from;
...
void ConnectionDescriptor::_WriteOutboundData()
{
	...
	if (ProxiedFrom && MaxOutboundBufSize && OutboundDataSize < MaxOutboundBufSize && ProxiedFrom->IsPaused())
		ProxiedFrom->Resume();
